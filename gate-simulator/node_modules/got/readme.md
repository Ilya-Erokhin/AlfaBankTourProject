...
Encoding to be used on `setEncoding` of the response ru.netology.data. If `null`, the body is returned as a Buffer.
...
## Form ru.netology.data

You can use the [`form-ru.netology.data`](https://github.com/form-ru.netology.data/form-ru.netology.data) module to create POST request with form ru.netology.data:

```js
const fs = require('fs');
const got = require('got');
const FormData = require('form-ru.netology.data');
